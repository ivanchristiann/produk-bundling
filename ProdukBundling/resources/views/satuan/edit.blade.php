...
<form method="POST" action="{{route('satuan.update', $satuan->id)}}">
    ...
    <div class="form-group">
        <label>Nama</label>
        <input type="text" name="nama" class="form-control" id="nama" value='{{old('nama', $satuan->nama)}}'>
        
        <label>Deskripsi</label>
        <input type="text" name="deskripsi" class="form-control" id="deskripsi" value='{{old('deskripsi', $satuan->deskripsi)}}'>      
    </div>
